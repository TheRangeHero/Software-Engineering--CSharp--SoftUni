...
namespace SmartphoneShop.Tests
{
    ...
    public class SmartphoneShopTests
    {
        ...
        [Test]
        public void Test_Constructor_IsSettingCorrectly()
        {
        ...
        [Test]
        public void Test_NegativeOrZeroCapacity_ShouldThrow()
        {
        ...
        [Test]
        public void Test_AddSmartphone_ShouldWork()
        {
            shop.Add(smartPhone);
        ...
        [Test]
        public void Test_DublicateSmartPhones_ShouldNotBeAllowed()
        {
            shop.Add(smartPhone);
            ...
            Assert.Throws<InvalidOperationException>(() =>
            {
                shop.Add(new Smartphone(modelName,100000));
            });
        }
        ...
        public void Test_PhoneCannotBeAdded_WhenCapacityIsFull()
        {
            ...
            Assert.Throws<InvalidOperationException>(() =>
            {
                shop.Add(new Smartphone("4", 100000));
            });
        }

        [Test]
        public void Test_RemoveSmartPhone_ShouldWork()
        {
            shop.Add(smartPhone);
        ...
        [Test]
        public void Test_RemovingShouldThrow_WhenPhoneIsNotFound()
        {
            Assert.Throws<InvalidOperationException>(() =>
            {
        ...
        [Test]
        public void Test_TestPhone_ShouldReduce_BatteryCharge()
        {
            shop.Add(smartPhone);
