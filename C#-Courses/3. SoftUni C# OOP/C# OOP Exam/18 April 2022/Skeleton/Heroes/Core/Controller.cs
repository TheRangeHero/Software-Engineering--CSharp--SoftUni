...
namespace Heroes.Core
{
    class Controller : IController
    {
        ...
        public string AddWeaponToHero(string weaponName, string heroName)
        {
            ...
            if (hero == null)
            {
                throw new InvalidOperationException($"Hero {heroName} does not exists.");
            }

            if (weapon == null)
            {
                throw new InvalidOperationException($"Weapon {weaponName} does not exists.");
            }
        ...
        public string StartBattle()
        {
            ...
            var heroesReadyForBattle = this.heroes.Models.Where(h => h.IsAlive && h.Weapon != null).ToList(); ;
        ...
        public string HeroReport()
        {
            ...
            {
                resul.AppendLine(hero.ToString());
            }

            return resul.ToString().TrimEnd();
        }
    }
}
